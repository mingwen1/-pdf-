...
import { TrendingUp, Users, Clock, Award, ArrowRight, CheckCircle2, AlertCircle } from 'lucide-react';
    ...
    <div className="space-y-8">
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="text-slate-500 mt-1">Track your team's AI training progress and ROI.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          { label: 'Training Pass Rate', value: '80%', sub: '+12% vs last month', icon: CheckCircle2, color: 'text-green-600', bg: 'bg-green-50' },
          { label: 'Active Scenarios', value: '124', sub: '5 new this week', icon: TrendingUp, color: 'text-blue-600', bg: 'bg-blue-50' },
          { label: 'Expert Hours Saved', value: '1,250h', sub: 'Est. value $150k', icon: Clock, color: 'text-purple-600', bg: 'bg-purple-50' },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-white p-6 rounded-xl shadow-sm border border-slate-100">
          <div className="flex justify-between items-center mb-6">
            <h3 className="font-bold text-slate-800 text-lg">Training Effectiveness Trend</h3>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
          <h3 className="font-bold text-slate-800 text-lg mb-4">Pending Actions</h3>
          <div className="space-y-4">
            {[
              { title: 'Approve New Sales Script', due: 'Today', type: 'urgent' },
              { title: 'Review Team Q3 Analysis', due: 'Tomorrow', type: 'normal' },
              { title: 'Update AI Persona: Dr. Li', due: 'Sep 20', type: 'normal' },
              ...
              <div key={i} className="flex items-start gap-3 p-3 rounded-lg hover:bg-slate-50 transition-colors cursor-pointer group">
                <div className={`mt-1 w-2 h-2 rounded-full ${task.type === 'urgent' ? 'bg-red-500' : task.type === 'system' ? 'bg-slate-400' : 'bg-blue-500'}`} />
      ...
      <div className="bg-gradient-to-r from-blue-900 to-slate-900 rounded-xl p-8 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            ...
            <h3 className="text-2xl font-bold mb-2">New Sales Champions Identified</h3>
            <p className="text-blue-100 max-w-xl">
              Your AI Coach has identified 3 potential top performers based on recent objection handling simulations. Check the analytics report for detailed breakdown.
            </p>
          </div>
          <button 
            onClick={() => onNavigate(Page.ANALYTICS)}
            className="px-6 py-3 bg-white text-blue-900 font-semibold rounded-lg hover:bg-blue-50 transition-all shadow-lg transform hover:-translate-y-1"
          >
            View Leaderboard
          </button>
        </div>
